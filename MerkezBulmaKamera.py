...
while True:
    ...
    ret, thresh = cv2.threshold(frame, 85, 255, 0)
    ret, thresh2 = cv2.threshold(median, 85, 255, 0)
    ...
    cv2.circle(frame, (cX, cY), 5, (150, 250, 250), -1)
    cv2.putText(frame, "centroid", (cX - 25, cY - 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (150, 250, 250), 2)

    cv2.circle(median, (cZ, cW), 5, (150, 250, 250), -1)
    cv2.putText(median, "merkez", (cZ - 25, cW - 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (150, 250, 250), 2)

    asilGoruntu = cv2.bitwise_and(frame, median,mask=mask)

    cv2.imshow("asıl", asilGoruntu)
